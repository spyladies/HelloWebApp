...
INSTALLED_APPS = [
    ...
    'django.contrib.humanize', #added Chapter 5
    'registration', #added Chapter 10.
]
...
ACCOUNT_ACTIVATION_DAYS = 7 #added chapter 10.

#Setting up ability to email, chapter 10.
...
LOGIN_REDIRECT_URL = "home" #We want to redirect after registration.  Chapter 10.
